...
## `r params$input_season` Schedule
...
The following visualization shows how `r params$team`'s offense has been in running/passing the ball since 2007.
...
The following visualization shows how `r params$team`'s **defense** has been in stopping the opponent's run/pass.
