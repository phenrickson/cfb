...
```{r get postseason games using cfbfast}

calendar = cfbd_calendar(params$input_season)

postseason_games = cfbd_game_info(params$input_season, week = 16)
