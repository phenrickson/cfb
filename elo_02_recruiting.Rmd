...
p = recruiting_teams %>% 
        filter(SEASON > 2006) %>%
        mutate(DIVISION_TYPE = case_when(DIVISION == 'fbs' ~ 'fbs',
                                         TRUE ~ 'fcs/other')) %>%
...
What is the relationship between recruiting and a team's win percentage?
...
Predict wins using Elo ratings vs using recruiting scores.
