...
To go to a mmore detailed report for an individual team, click on the Team's name.
...
# get table ready
team_predictions %>%
        mutate(TEAM = paste('<a href="https://phenrickson.github.io/cfb/team_profiles/season/', params$input_season, "/", TEAM, '.html','">', TEAM, '</a>', sep="")) %>%
