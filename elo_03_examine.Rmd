...
Which teams have changed the most year over year? 
...
Here are the biggest drops from the end of season to the end of the next.
...
diff_func = 
                function(x) {
                        ...
                        breaks = c(-1000, -700, seq(-650, 650, 50), 700, 1000)
...
## Biggest Swings in Elo

Which games saw the largest drop in Elo? 
