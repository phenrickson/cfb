...
```{r indicate where tamu offense falls}
...
scored_plays %>%
        ...
        ggtitle(paste(team, "Offense/Defense Efficency by Game"),
                subtitle = str_wrap("Measuring offensive and defensive efficiency via predicted points added. Offenses (in blue) are more efficient the higher their predicted points added. Defenses (in red) are more efficient the lower the predicted points added by the opponent's offense. Model estimates from multinomial logistic regression.",120))
