...
This table displays the results of simulating week `r params$sim_week+1` of the `r params$input_season` CFB season `r `params$nsims` times. These simulations are run one week in advance, using information available in the lead up to `r params$sim_week+1` - for the first week of the season, team ratings are based solely on information from previous seasons. Quality is the (harmonic) mean of the two team's overall rating, with 100 indicating a game between highly rated opponents. Pr(HomeWin) is the percentage of times that the home team won the game across every simulation.
        ...
        datatable(escape=F,
                  ...
                  options = list(pageLength = 25,
                                 ...
                                 columnDefs = list(
                                         list(className = 'dt-center',
                                              visible=T,
                                              targets=c("Season", "Week", "Quality", "Home", "Away", "Pr(HomeWin)", "Prediction", "Result", "Correct")),
                                         list(className = 'dt-center',
                                                        visible=F,
                                                        targets=c("correct"))))) %>%
        formatStyle(c("Quality"),
