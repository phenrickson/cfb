...
games_and_outcomes = games %>%
        ...
        mutate(INTEREST = (0.5 * COMPETITIVE) + (0.5 * QUALITY)) %>%
...
**Quality** indicates the quality of the game based on the pre game ratings of the teams. This is the (harmonic) mean of the two team's rating and ranges from 0 to 100, with 100 indicating a game between highly rated opponents.

<!-- **Competitive** indicates how competitive a matchup is expected to be based on the the pre game home win probability. This ranges from 0 to 100, with 100 indicating a game between teams with identical ratings and 0 indicating a game that that where the home team is extremely likely to win or lose.  -->

**Interest** indicates the how interesting a matchup is expected to be based on the **Quality** of the teams and how competitive the game is expected to be. This ranges from 0 to 100, where 100 indicates a competitive game between two highly rated opponents.
...
games_and_outcomes %>%
      ...
      #  mutate(Name = paste('<a href="https://boardgamegeek.com/boardgame/', ID, '">', Name, '</a>', sep="")) %>%
        select(SEASON, WEEK, QUALITY, 
               #COMPETITIVE, 
               INTEREST, 
               HOME, AWAY, HOME_PROB, PRED, OUTCOME, 
               #Correct, 
               correct) %>%
                  ...
                  options = list(pageLength = 25,
                                 ...
                                 columnDefs = list(
                                         list(className = 'dt-center',
                                              visible=T,
                                              targets=c("Season", "Week", "Quality", "Interest", "Pr(HomeWin)", "Home", "Away", "Prediction", "Result")),
                                         list(className = 'dt-center',
                                                        visible=F,
                                                        targets=c("correct"))))) %>%
        formatStyle(c("Quality", "Interest"),
                  #  color = 'white',
