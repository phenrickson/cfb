...
## Initial Settings: 1960-2000

Okay, so at this point we have what we need in order to build out Elo Ratings for college football games. We could start this analysis going back all the way to 1869 as the starting point, but I'll start at 1960 for now since I'm at least somewhat familiar with teams in this era and will be able to eyeball the results.
...
Once that finishes, we have the accumulation of Elo ratings as a function of game outcomes over the selected time period. For instance, here is how each SEC team's Elo ratings fared.
...
We can simulate the point differential and compare it to the actual. I'll look at the 1990 season, week by week to see the simulated result vs actual.
...
## Initial Settings + Mean Reversion: 1960-2000
...
## Initial Settings + Mean Reversion + Home Team Advantage: 1960-2000
